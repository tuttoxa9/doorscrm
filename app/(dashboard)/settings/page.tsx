    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general" className="space-y-4">
        <TabsList className="grid w-full grid-cols-4 bg-muted dark:bg-muted">
          <TabsTrigger value="general" className="data-[state=active]:bg-background dark:data-[state=active]:bg-background">Основные</TabsTrigger>
          <TabsTrigger value="seo" className="data-[state=active]:bg-background dark:data-[state=active]:bg-background">SEO</TabsTrigger>
          <TabsTrigger value="database" className="data-[state=active]:bg-background dark:data-[state=active]:bg-background">База данных</TabsTrigger>
          <TabsTrigger value="danger" className="data-[state=active]:bg-background dark:data-[state=active]:bg-background">Опасная зона</TabsTrigger>
        </TabsList>
            ...
            <CardContent>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div className="flex items-center justify-between p-3 border rounded-lg bg-card hover:bg-accent/50 transition-colors">
                  ...
                  <span className="text-lg font-bold text-primary">{dataStats.products}</span>
                </div>
                <div className="flex items-center justify-between p-3 border rounded-lg bg-card hover:bg-accent/50 transition-colors">
                  <div className="flex items-center gap-2">
                    <FolderOpen className="h-4 w-4 text-orange-500 dark:text-orange-400" />
                    <span className="text-sm font-medium">Категории</span>
                  </div>
                  <span className="text-lg font-bold text-primary">{dataStats.categories}</span>
                </div>
                <div className="flex items-center justify-between p-3 border rounded-lg bg-card hover:bg-accent/50 transition-colors">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-bold text-primary">{dataStats.orders}</span>
                </div>
                <div className="flex items-center justify-between p-3 border rounded-lg bg-card hover:bg-accent/50 transition-colors">
                  <div className="flex items-center gap-2">
                    <Images className="h-4 w-4 text-purple-500 dark:text-purple-400" />
                    <span className="text-sm font-medium">Галерея</span>
                  </div>
                  <span className="text-lg font-bold text-primary">{dataStats.gallery}</span>
                </div>
                <div className="flex items-center justify-between p-3 border rounded-lg bg-card hover:bg-accent/50 transition-colors">
                  <div className="flex items-center gap-2">
                    <Users2 className="h-4 w-4 text-indigo-500 dark:text-indigo-400" />
                    <span className="text-sm font-medium">Пользователи</span>
                  </div>
                  <span className="text-lg font-bold text-primary">{dataStats.users}</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <Button
                    variant="outline"
                    className="justify-start border-destructive dark:border-red-600 text-destructive dark:text-red-400 hover:bg-destructive hover:text-destructive-foreground dark:hover:bg-red-600 dark:hover:text-white"
                    onClick={() =>
                      openDeleteDialog(
                        "products",
                        "Удалить все товары",
              ...
              <div>
                <h4 className="text-sm font-medium mb-3 text-destructive dark:text-red-400">Полная очистка</h4>
                <Button
                  variant="destructive"
                  className="w-full bg-destructive hover:bg-destructive/90 dark:bg-red-600 dark:hover:bg-red-700"
                  onClick={() =>
                    openDeleteDialog(
                      "all",
                      "УДАЛИТЬ ВСЕ ДАННЫЕ",
