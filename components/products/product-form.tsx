      ...
      <div className="space-y-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <Input id="name" className="h-9" {...register("name", { required: "Название обязательно" })} />
          ...
          <div className="space-y-1">
            ...
            <Input id="category" className="h-9" {...register("category", { required: "Категория обязательна" })} />
        ...
        <div className="space-y-1">
          ...
          <Textarea id="description" rows={2} className="text-sm resize-none" {...register("description")} />
        </div>
        ...
        <div className="space-y-2">
          ...
          {colors.length > 0 && (
            <div className="flex flex-wrap gap-1">
              {colors.map((color, index) => (
                <Badge key={index} variant="secondary" className="text-xs flex items-center gap-1 h-6">
                  {color}
          ...
          <div className="flex gap-2">
            ...
            />
            <Button type="button" variant="outline" size="sm" onClick={handleAddColor} className="px-2">
